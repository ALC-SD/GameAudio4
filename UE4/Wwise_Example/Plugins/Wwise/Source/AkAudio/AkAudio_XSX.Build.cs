...
public class AkUEPlatform_XSX : AkUEPlatform
{
	public AkUEPlatform_XSX(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
...
public class AkUEPlatform_MPX : AkUEPlatform_XSX
{
	public AkUEPlatform_MPX(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
}